...
function SpeakerCard({imageSrc="", name="", description=""}) {
  return (
    <div className='flex flex-col rounded-3xl border border-gray-300 poppins-italic p-6 items-center gap-2 lg:w-2/3 w-full mx-auto shadow-md'>
        <div><img src={imageSrc} alt={name} className='h-50 w-50 rounded-2xl object-cover'/></div>
